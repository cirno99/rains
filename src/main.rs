...
use crossterm::{ExecutableCommand, cursor, style::Stylize, terminal, terminal::ClearType};
use once_cell::sync::Lazy;
use owo_colors::OwoColorize;
use pinyin::{ToPinyin, ToPinyinMulti};
use rains::{
    cli::{Opts, Subcommand},
    invest::{Exchange, Investment, Market, quote::Quote},
    sina::Sina,
};
use regex::Regex;
    ...
    match args.cmd {
        ...
        Subcommand::Quote { symbol, no_check, realtime, multiline } => {
            ...
            if realtime {
                ...
                let _ = Sina::quotes_ws(&symbols, |quotes: Vec<Quote>| {
